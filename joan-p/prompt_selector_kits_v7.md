...
**Si el usuario dice "sí, es nuevo" O proporciona un año superior al `model_max_year` del modelo:**
...
- Esto captura correctamente todos los kits vigentes (ej: KC20050500 desde 2021 y KC22030546 desde 2020, ambos vigentes).
- Añade una nota discreta al resultado final: "⚠️ Vehicle [año] — compatibilitat pendent de confirmació tècnica amb Oliva Torras."
...
Solo preguntar si el usuario NO ha respondido "sí, es nuevo".
...
1. **Tensor automático** (`flag_auto_tensioner`):
   - "¿Quieres el kit con tensor automático (intervalos de mantenimiento más largos) o tensor estándar?"
...
🔧 Embrague:
  ...
  · Versión con embrague especial disponible (embrague incluido en el kit):
    - [CODE]E — TM / UP / UNICLA · [embrague_esp]
    - [CODE]S — SANDEN (SD...) · [embrague_esp]
(mostrar solo las variantes que correspondan según tipus_embrague)
```
→ Preguntar: "¿Necesitas la versión con embrague especial incluido?"

---

### TABLA DE SUFIJOS según `tipus_embrague`:
| `tipus_embrague` | Versiones disponibles |
|---|---|
| `N` o vacío | Solo kit base — embrague NO incluido, sin versiones E/S |
| `N-E` | Kit base (sin embrague) + **[CODE]E** (con embrague, TM/UP/UNICLA) |
| `N-S` | Kit base (sin embrague) + **[CODE]S** (con embrague, SANDEN SD...) |
| `N-E/S` | Kit base (sin embrague) + **[CODE]E** + **[CODE]S** (ambos con embrague) |
